...
var Resources = map[string]ResourceStructure{
	...
	"ise":    {"integration service environment", "ise", 1, 24, false, alphanum, "^[0-9a-zA-Z]{1,24}$", true, "resourceGroup"},
	...
	"logic":  {"logic app workflow", "logic", 4, 63, false, alphanumh, "^[0-9a-zA-Z][0-9A-Za-z-]{3,61}[0-9a-zA-Z]$", true, "resourceGroup"},
	"laac":   {"logic app action custom", "laac", 4, 63, false, alphanumh, "^[0-9a-zA-Z][0-9A-Za-z-]{3,61}[0-9a-zA-Z]$", true, "resourceGroup"},
	"laah":   {"logic app action http", "laah", 4, 63, false, alphanumh, "^[0-9a-zA-Z][0-9A-Za-z-]{3,61}[0-9a-zA-Z]$", true, "resourceGroup"},
	"ia":     {"logic app integration account", "ia", 4, 63, false, alphanumh, "^[0-9a-zA-Z][0-9A-Za-z-]{3,61}[0-9a-zA-Z]$", true, "resourceGroup"},
	"latc":   {"logic app trigger custom", "latc", 4, 63, false, alphanumh, "^[0-9a-zA-Z][0-9A-Za-z-]{3,61}[0-9a-zA-Z]$", true, "resourceGroup"},
	"latr":   {"logic app trigger recurrence", "latr", 4, 63, false, alphanumh, "^[0-9a-zA-Z][0-9A-Za-z-]{3,61}[0-9a-zA-Z]$", true, "resourceGroup"},
	"lathr":  {"logic app trigger http request", "lathr", 4, 63, false, alphanumh, "^[0-9a-zA-Z][0-9A-Za-z-]{3,61}[0-9a-zA-Z]$", true, "resourceGroup"},
...
var ResourcesMapping = map[string]ResourceStructure{
	...
	"azurerm_logic_app_action_custom":         Resources["laac"],
	"azurerm_logic_app_action_http":           Resources["laah"],
	"azurerm_logic_app_integration_account":   Resources["laia"],
	"azurerm_logic_app_trigger_custom":        Resources["latc"],
	"azurerm_logic_app_trigger_http_request":  Resources["lathr"],
	"azurerm_logic_app_trigger_recurrence":    Resources["latr"],
