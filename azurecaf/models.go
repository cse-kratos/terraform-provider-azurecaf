...
var Resources = map[string]ResourceStructure{
	...
	"func":   {"function app", "func", 2, 60, false, alphanumh, "^[a-zA-Z][0-9A-Za-z-]{0,58}[0-9a-zA-Z]$", true, "resourceGroup"},
	"gen":    {"generic", "gen", 1, 24, false, alphanum, "^[0-9a-zA-Z]{1,24}$", true, "resourceGroup"},
	"ise":    {"integration service environment", "ise", 1, 80, false, alphanumhup, "^[0-9a-zA-Z][0-9A-Za-z-]{0,78}[0-9a-zA-Z]$", true, "resourceGroup"},
	...
	"logic":  {"logic app workflow", "logic", 1, 80, false, alphanumhup, "^[0-9a-zA-Z][0-9A-Za-z-]{0,78}[0-9a-zA-Z]$", true, "resourceGroup"},
	"ia":     {"logic app integration account", "ia", 1, 80, false, alphanumhup, "^[0-9a-zA-Z][0-9A-Za-z-]{0,78}[0-9a-zA-Z]$", true, "resourceGroup"},
